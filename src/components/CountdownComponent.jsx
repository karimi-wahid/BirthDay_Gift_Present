  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center relative">
      ...
      <motion.div
        ...
        {/* Glowing Effect */}
        <motion.div
          className="absolute inset-0 rounded-3xl bg-gradient-glow z-10"
        ...
        <motion.div
          ...
          <motion.h1
            className="text-4xl sm:text-6xl md:text-7xl font-bold text-white mb-4 font-mono tracking-wider"
            animate={{
              textShadow: [
