    ...
    <>
      <div className="flex flex-col items-center justify-center min-h-screen text-center px-6">
        <motion.div
          ...
          <motion.div
            className="realtive p-12 md:p-16 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 shadow-romantic"
            ...
            <motion.p
              className="text-xl md:text-2xl text-romantic-purple/50 italic mb-12"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
